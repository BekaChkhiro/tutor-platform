...
export function RegisterForm() {
  ...
  const {
    ...
    resolver: zodResolver(userRegistrationFormSchema as any),
  });

  async function onSubmit(data: UserRegistrationInput) {
    setServerError(null);
  ...
  return (
    <div className="mx-auto w-full max-w-sm space-y-6">
      ...
      <p className="text-muted-foreground text-center text-sm">
        Applying as a tutor?{' '}
        <Link href="/register/tutor" className="text-foreground font-medium hover:underline">
          Tutor registration
        </Link>
      </p>
    </div>
