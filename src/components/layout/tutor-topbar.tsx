...
export function TutorTopbar({ session, mobileNav }: TutorTopbarProps) {
  ...
  return (
    <header className="bg-background border-border sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b px-4">
      <MobileDrawer label="Tutor navigation">{mobileNav}</MobileDrawer>

      <Link href="/tutor/dashboard" className="text-foreground font-semibold md:hidden">
        Tutor Portal
      </Link>
